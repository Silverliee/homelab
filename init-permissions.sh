...
# Configuration
DOCKER_USER_ID=${PUID:-0}
DOCKER_GROUP_ID=${PGID:-0}
...
# =============================================================================
# 6. Create .env file with image-specific variables if not exists
# =============================================================================
if [ -f .env ]; then
  ...
  DUPLICATI_ENCRYPTION_KEY=default
  DUPLICATI_WEBSERVICE_PASSWORD=default
